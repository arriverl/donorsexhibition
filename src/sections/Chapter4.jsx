...
export default function Chapter4() {
  ...
  const explorers = [
    {
      name: '斯坦因',
      description: '1907年奥雷尔・斯坦因来到敦煌，通过谎称自己是印度来的僧人，沿玄奘足迹求取佛经，骗取王道士的信任，以四块银锭换走五十捆汉文写卷、五捆藏文写卷，另有一批画作、织物、雕版印刷品及各类器物。1914年，又以极低的价格从王道士手中买走了几百卷写本，装满四大箱。如今，大部分藏品收藏于大英博物馆、大英图书馆、维多利亚与阿尔伯特博物馆，以及印度新德里国家博物馆。'
    },
    {
      name: '伯希和',
